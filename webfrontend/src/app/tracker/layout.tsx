  ...
  return (
    <section className="flex flex-row justify-start h-screen">
      ...
      <div className="flex flex-col justify-start w-10/12 h-screen flex-grow">
        <nav className="flex flex-row h-16 sticky top-0 justify-end drop-shadow-sm  shadow-gray-100">
          <HeadBarContainer />
        </nav>
        <article className="flex flex-row justify-center bg-white w-full overflow-y-auto h-screen">
          {children}
        </article>
      </div>
    </section>

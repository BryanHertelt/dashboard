...
export const ReloadSingleHoldingIcon = ({
  ...
  const currentHolding = syncStatus.find(
    ...
    }) => item.holdingId === rowId
  );

  if (currentHolding?.status === "noSync") {
    return (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="10"
  ...
  } else if (currentHolding?.status === "syncing") {
    return (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="12"
      ...
      >
        <defs>
          ...
          <clipPath id="paint0_angular_4206_72705_clip_path">
        ...
        <g clipPath="url(#paint0_angular_4206_72705_clip_path)">
  ...
  } else if (currentHolding?.status === "synced") {
    return (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="10"
